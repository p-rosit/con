...
test "context init" {
    ...
    const init_err = con.con_serialize_init(
        &context,
        con.con_writer_string_interface(&writer),
        &depth,
        0,
    );
...
test "number int-like" {
    ...
    var writer: con.ConWriterString = undefined;
    const writer_err = con.con_writer_string_context(&writer, &buffer, buffer.len + 1);
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), writer_err);
    ...
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), num_err);
}
...
test "number null" {
    ...
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_NULL), num_err);
}
...
test "number writer fail" {
    ...
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_WRITER), num_err);
}
...
test "number empty" {
    ...
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_NOT_NUMBER), num_err);
}
...
test "string" {
    ...
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), str_err);
}
...
test "string null" {
    ...
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_NULL), str_err);
}
...
test "string first quote writer fail" {
    ...
    const str_err = con.con_serialize_string(&context, "-");
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_WRITER), str_err);
}
...
test "bool true" {
    ...
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), bool_err);
...
test "bool true writer fail" {
    ...
    const bool_err = con.con_serialize_bool(&context, true);
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_WRITER), bool_err);
}
...
test "null" {
    ...
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), null_err);
...
test "null writer fail" {
    ...
    const null_err = con.con_serialize_null(&context);
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_WRITER), null_err);
}
...
test "array open" {
    ...
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), open_err);
...
test "array open too many" {
    ...
    const open_err = con.con_serialize_array_open(&context);
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_TOO_DEEP), open_err);
}
...
test "array nested open too many" {
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_TOO_DEEP), err);
    }
}
...
test "array open writer fail" {
    ...
    const open_err = con.con_serialize_array_open(&context);
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_WRITER), open_err);
}
...
test "array close" {
    ...
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), close_err);
...
test "array close too many" {
    ...
    const close_err = con.con_serialize_array_close(&context);
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_CLOSED_TOO_MANY), close_err);
}
...
test "array close writer fail" {
    ...
    const close_err = con.con_serialize_array_close(&context);
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_WRITER), close_err);
}
...
test "dict key" {
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), key_err);
...
test "dict key multiple" {
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), item_err);
...
test "dict key null" {
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_NULL), key_err);
    }
}
...
test "dict key first quote writer fail" {
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_WRITER), key_err);
        try testing.expectEqualStrings("{", &buffer);
    }
}
...
test "dict key comma writer fail" {
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), key1_err);
        const item1_err = con.con_serialize_number(&context, "1");
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), item1_err);
        try testing.expectEqualStrings("{\"a\":1", &buffer);

        const key2_err = con.con_serialize_dict_key(&context, "2");
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_WRITER), key2_err);
    }
}
...
test "dict key outside dict" {
    ...
    const key_err = con.con_serialize_dict_key(&context, "key");
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_NOT_DICT), key_err);
}
...
test "dict key twice" {
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_VALUE), key2_err);
    }
}
...
test "dict number key missing" {
    ...
    {
        const num_err = con.con_serialize_number(&context, "2");
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_KEY), num_err);
    }
}
...
test "dict string key missing" {
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_KEY), str_err);
    }
}
...
test "dict array key missing" {
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_KEY), array_err);
    }
}
...
test "dict dict key missing" {
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_KEY), dict_err);
    }
}
...
test "array open -> dict close" {
    ...
    const close_err = con.con_serialize_dict_close(&context);
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_NOT_DICT), close_err);
}
...
test "dict open -> array close" {
    ...
    const close_err = con.con_serialize_array_close(&context);
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_NOT_ARRAY), close_err);
}
...
test "array number multiple" {
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), item2_err);
    }
...
test "array number comma writer fail" {
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_WRITER), item2_err);
    }
}
...
test "array array single" {
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), sub_open_err);
        const sub_close_err = con.con_serialize_array_close(&context);
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), sub_close_err);
    }
...
test "array array multiple" {
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), sub_open_err1);
        const sub_close_err1 = con.con_serialize_array_close(&context);
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), sub_close_err1);

        const sub_open_err2 = con.con_serialize_array_open(&context);
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), sub_open_err2);
        const sub_close_err2 = con.con_serialize_array_close(&context);
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), sub_close_err2);
    }
...
test "array array comma writer fail" {
...

    {
        ...
        const sub_open_err2 = con.con_serialize_array_open(&context);
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_WRITER), sub_open_err2);
    }
}
...
test "number complete" {
    ...
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_COMPLETE), err);
}
...
test "bool complete" {
    ...
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), complete_err);
...
test "nested structures" {
    ...
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), open_err1);

    {
        const key_err2 = con.con_serialize_dict_key(&context, "a");
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), key_err2);
        const open_err2 = con.con_serialize_array_open(&context);
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), open_err2);
        {
            const str_err4 = con.con_serialize_string(&context, "hello");
            try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), str_err4);

            const open_err5 = con.con_serialize_dict_open(&context);
            try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), open_err5);
            {
                const key_err6 = con.con_serialize_dict_key(&context, "a.a");
                try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), key_err6);
                const null_err6 = con.con_serialize_null(&context);
                try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), null_err6);

                const key_err7 = con.con_serialize_dict_key(&context, "a.b");
                try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), key_err7);
                const bool_err7 = con.con_serialize_bool(&context, true);
                try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), bool_err7);
            }
            const close_err5 = con.con_serialize_dict_close(&context);
            try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), close_err5);
        }
        const close_err2 = con.con_serialize_array_close(&context);
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), close_err2);

        const key_err3 = con.con_serialize_dict_key(&context, "b");
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), key_err3);
        const open_err3 = con.con_serialize_array_open(&context);
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), open_err3);
        {
            const num_err8 = con.con_serialize_number(&context, "234");
            try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), num_err8);

            const bool_err9 = con.con_serialize_bool(&context, false);
            try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), bool_err9);
        }
        const close_err3 = con.con_serialize_array_close(&context);
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), close_err3);
    }

    const close_err1 = con.con_serialize_dict_close(&context);
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), close_err1);
...
test "indent writer" {
    ...
    const indent_err = con.con_writer_indent_context(
        &indent,
        con.con_writer_string_interface(&writer),
    );
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), indent_err);

    var depth: [3]u8 = undefined;
    var context: con.ConSerialize = undefined;
    const init_err = con.con_serialize_init(
        &context,
        con.con_writer_indent_interface(&indent),
        &depth,
        depth.len,
    );
    try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), init_err);
...

    {
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), open_dict_err);

        {
            const key1_err = con.con_serialize_dict_key(&context, "key1");
            try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), key1_err);
            const empty_open_array_err = con.con_serialize_array_open(&context);
            try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), empty_open_array_err);
            const empty_close_array_err = con.con_serialize_array_close(&context);
            try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), empty_close_array_err);

            const key2_err = con.con_serialize_dict_key(&context, "key2");
            try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), key2_err);
            const empty_open_dict_err = con.con_serialize_dict_open(&context);
            try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), empty_open_dict_err);
            const empty_close_dict_err = con.con_serialize_dict_close(&context);
            try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), empty_close_dict_err);

            const key3_err = con.con_serialize_dict_key(&context, "key3");
            try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), key3_err);
            const bool_err = con.con_serialize_bool(&context, true);
            try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), bool_err);
        }

        const close_dict_err = con.con_serialize_dict_close(&context);
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), close_dict_err);
        ...
        try testing.expectEqual(@as(c_uint, con.CON_ERROR_OK), no_indent_err);
