...
test "init" {
    ...
    try testing.expectEqual(con.CON_SERIALIZE_OK, init_err);
...
test "init_null_context" {
    ...
    try testing.expectEqual(con.CON_SERIALIZE_NULL, init_err);
}
...
test "init_negative_buffer" {
    ...
    try testing.expectEqual(con.CON_SERIALIZE_BUFFER, init_err);
}
...
test "current_position" {
    ...
    try testing.expectEqual(con.CON_SERIALIZE_OK, pos_err);
...
test "current_position_null_out" {
    ...
    try testing.expectEqual(con.CON_SERIALIZE_NULL, pos_err);
}
...
test "set_buffer" {
    ...
    try testing.expectEqual(con.CON_SERIALIZE_OK, set_err);
...
test "set_negative_buffer" {
    ...
    try testing.expectEqual(con.CON_SERIALIZE_BUFFER, set_err);
}
...
test "get_buffer" {
    ...
    try testing.expectEqual(con.CON_SERIALIZE_OK, get_err);
...
test "get_buffer_null_buffer_out" {
    ...
    try testing.expectEqual(con.CON_SERIALIZE_NULL, get_err);
...
test "clear_buffer" {
    ...
    try testing.expectEqual(con.CON_SERIALIZE_OK, clear_err);
